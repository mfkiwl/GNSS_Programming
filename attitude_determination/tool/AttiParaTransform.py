...
@title:	Attitude Parameterization Transform
@author: iDeal0103
@status:	Active
@type:	Process
@created:	25-Jan-2022
...
if __name__ == "__main__":
    ...
    # 欧拉角到旋转矩阵
    r4 = Rotation.from_euler('zxy', [-179.99564367, -87.99992566, 179.99579836], degrees=True)
    rm = r4.as_matrix()
    ...
    # ----测试--------------------------------------------------------------------
    theta = [-116, 0., -105]
    r6 = Rotation.from_euler('xyz', theta, degrees=True)
    rm = r6.as_matrix()
