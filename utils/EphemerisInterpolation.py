...
if __name__ == "__main__":
    igs_file=r"D:\Desktop\igs21390.sp3"
    pe_records=DoFile.read_GPS_sp3File(igs_file)
    the_time=datetime.datetime(2021, 1, 3, 1, 59, 59, microsecond=331323)
    print(the_time)
    print(cal_XYZ_basedon_preciseephemeris(pe_records, the_time, "25"))
